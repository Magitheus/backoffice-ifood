function carregarTransacoes() {
  fetch("../scripts/dados.json")
    ...
    .then((data) => {
      const transacoesFuncionario = data.transacoes.filter((transacao) =>
        ["Salário", "Auxílio", "Encargos"].includes(transacao.categoria)
      );
      console.log(transacoesFuncionario);
      renderizarTransacoes(transacoesFuncionario);
    })
